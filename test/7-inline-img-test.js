...
describe('inline <img>', () => {
  ...
  it('should not inline content when options.ignore includes "svg"', async () => {
    ...
    const html = await inlineSource(test, { compress: true, ignore: ['svg'] });
...
<circle cx="50" cy="50" r="25"/>
  ...
  it('should inline svg sources when attribute=false', async () => {
    ...
    const html = normaliseNewLine(await inlineSource(test, { attribute: false, compress: false }));
    expect(html).to
      .eql(`<svg id="Layer_1" x="100px" y="100px" enable-background="new 0 0 100 100" xml:space="preserve" viewBox="0 0 200 200">
<circle cx="50" cy="50" r="25"/>
</svg>`);
  ...
  it('should skip inlining img sources if empty "src"', async () => {
    ...
    const html = await inlineSource(test, { compress: true, attribute: false });
    expect(html).to.eql(
      '<img id="foo" src="" /><img id="foo" src="data:image/png;base64,"/>',
    );
  });
  it('should inline icon link in base64 format', async () => {
    const test = '<link rel="icon" inline href="foo.svg" type="image/svg+xml" />';
    const html = await inlineSource(test, { compress: true });
    expect(html).to.eql(
      '<link rel="icon" type="image/svg+xml" href="data:image/svg+xml;base64,"/>',
    );
  });
});
